    ...
    while(1)
    {
        ...
        if(strncmp(command,"register", 8) == 0)
        {
            ...
            else
            {
                ...
                fprintf(fptr,cJSON_PrintUnformatted(json));
                fclose(fptr);
            ...
            if(strncmp(command,"channel", 6) == 0)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        fprintf(fptr,cJSON_PrintUnformatted(json2));
                        fclose(fptr);
        ...
        if(strncmp(command,"send", 4) == 0)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    fprintf(fptr_for_writing,cJSON_PrintUnformatted(json2));
            ...
            else
            {
                ...
                else
                {
                    ...
                    cJSON_AddItemToArray(messages_to_show , cJSON_GetArrayItem(array , online_users[find_token(token)].index_message));
                        ...
                        //cJSON_GetArrayItem()
                    //printf("%s", cJSON_PrintUnformatted(cJSON_GetArrayItem(array , i)));
...
void send_respond(cJSON * respond , int size)
{
    ...
    strcpy(string_respond, cJSON_PrintUnformatted(respond)) ;
    printf("server's response : %s \n", cJSON_PrintUnformatted(respond));
